...
<tr>
	...
	<form id="form" method="POST" action="<?=base_url()?>report/reportEmployee/" >
		<fieldset class="form-fieldset">
		<legend class="form-legend">Employee Detail Report Filter</legend>
		<table align=center>
		<tr><td>&nbsp;</tr>
...
<fieldset class="form-fieldset">
<legend class="form-legend">Employee Detail Report</legend>
</fieldset>
<table align=center>
<tr><td> <td></tr>
