...
<tr>
	...
	<form id="form" method="POST" action="<?=$site ?>/report/reportEmployeeSummary/" >
		<fieldset class="form-fieldset">
		<legend class="form-legend">Summary Report by  Employee</legend>
		<table align=center>
		<tr>
...
<thead>
<tr>
  <th class="table-head" colspan="8">Summary Report by  Employee</th>
</tr>
<tr>
	<th rowspan=2>No</th>
	<th rowspan=2>NIK</th>
