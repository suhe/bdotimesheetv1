...
<tr>
	...
	<form id="form" method="POST" action="<?=$site ?>/report/reportAbsentByEmployee/" >
		<fieldset class="form-fieldset">
		<legend class="form-legend">Detail Absent By Employee Filter</legend>
		<table align=center>
		<tr><td>&nbsp;</tr>
...
<fieldset class="form-fieldset">
<legend class="form-legend">Detail Absent By Employee</legend>
</fieldset>
<table align=center>
<tr><td>&nbsp;</tr>
<tr>
...
<thead>
<tr>
  <th class="table-head" colspan="14">Details Absent By Employee</th>
</tr>
<tr>
	<th>No</th>
	<th>Day</th>
	...
	<th class='currency'>Created Date</th>
</tr>
</thead>
	<tbody>
   <?=$row?>
