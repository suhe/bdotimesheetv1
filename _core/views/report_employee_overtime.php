...
<tr>
	...
	<form id="form" method="POST" action="<?=$site ?>/report/reportEmployeeOvertime/" >
		<fieldset class="form-fieldset">
		<legend class="form-legend">Summary of Overtime Hours</legend>
		<table align=center>
		<tr>
...
<thead>
<tr>
  <th class="table-head" colspan="9">Summary Report by  Employee</th>
</tr>
<tr>
	<th>No</th>
	<th>NIK</th>
	...
	<tbody>
   <?=$row ?>
  <tr><td colspan="7"><i>printed date <?=date("d M Y H:i:s");  ?></i>
	</tbody>
	</table>
</div>
</div>
