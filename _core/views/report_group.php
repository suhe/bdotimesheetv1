...
$employee_data = $this->reportModel->getDepartment();
$employee = '';
if ( count( $employee_data ) > 0 ) {
	$employee .='<select name=department_id>';
...
<tr>
	...
	<form id="form" method="POST" action="<?=$site ?>/report/reportGroup/" >
		<fieldset class="form-fieldset">
		<legend class="form-legend">Report Attandance by Group</legend>
		<table align=center>
		<tr><td>&nbsp;</tr>
