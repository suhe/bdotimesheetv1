...
?>
			<div class="grid_12">
				<h2 id="page-heading">Employee Data</h2>
			</div>
			<div class="grid_12">
			<div class="box">
			...
			<div class="box">
				<h2><a id="toggle-tables" href="#">Employee List </a></h2>
				<div id="tables" class="block">
					<div id="paging">
						...
						<span style="float:right;text-align:right;"><a href="<?=$site?>data/employeeEdit/0" > [ ADD NEW ] </a></span>
...
if ( $table ) {
	...
	foreach ($table as $k=>$v) {
		...
		echo "</td>
		      ...
		      <td>$v[department]</td>
              <td>$v[passtext]</td>
		      <td align='right'><a href='".$site."data/employeeEdit/$v[employee_id]'>[ edit ]</a></td></tr>";
		$i++;
	}
}
?>
