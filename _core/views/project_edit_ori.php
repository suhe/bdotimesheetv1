...
<div class="grid_12">
	...
	<table style="vertical-align:top;">
		<tr>
			...
			<td><?=$cClient ?> Required &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=checkbox name=support value="<?=$form['location'] ?>" style='padding-left:10px;' <?=$xchecked; ?> />Supporting Project </td>
		</td>
		<tr>
			<td class="label">Engagement / Contract Number : </td>
			<td><input type="text"  class="inputtext mandatory" id="contract_no" name="contract_no"  value="<?=$form['contract_no'] ?>" size="40" /> Required</td>
		</td>
		<tr>
			<td class="label" nowrap style="width:180px;">Financial Year End : </td>
			<td><input type="text"  class="inputtext date mandatory" readonly="true" id="year_end" name="year_end" value="<?=$year_end ?>" size="40" style="width:80px;"/> Required</td>
		</tr>
		<tr>
			<td class="label">Job Type : </td>
			<td><?=$cJobType ?>  Required</td>
		</td>
		<tr>
			<td class="label">Project Code : </td>
			<td><input type="text"  class="inputtext mandatory" id="project_no" name="project_no" value="<?=$form['project_no'] ?>" size="40" /> Required</td>
		</td>
<!--
		<tr>
...
-->		
		<tr>
			...
			<td><input type="text"  class="inputtext date" readonly="true" id="start_date" name="start_date" value="<?=$start_date ?>" size="40" style="width:80px;" style="width:80px;"/>
				 &nbsp;&nbsp; Finish Date :  &nbsp;&nbsp;	
				<input type="text"  class="inputtext date" readonly="true" id="finish_date" name="finish_date" value="<?=$finish_date ?>" size="40" style="width:80px;" style="width:80px;"/>
			</td>
		</tr>
		<tr>
...
<tr><td colspan="2">
	<form id="form_job" method="POST" action="<?=$site ?>/project/BudgetCost/" >
		<input type="hidden" id="project_id" name="project_id" value="<?=$form['project_id'] ?>" />
...
<table class="grid">
	...
	<tr><td align="left" colspan=17> <div id="paging">	
				<span style="float:right;text-align:right;"><a href="<?=$site?>/project/jobEdit/<?=$form['project_id'] ?>/del" > [ DELETE ] </a></span>
				<span style="float:right;text-align:right;">&nbsp;&nbsp;&nbsp;</span>
				<span style="float:right;text-align:right;"><a href="<?=$site?>/project/jobEdit/<?=$form['project_id'] ?>/add" > [ ADD NEW ] </a></span> 
  ...
  $total_row_hour = 0;
	...
	if ( $table_job ) {
      ...
      //$row_hour  = $v['01_hour'] + $v['02_hour'] + $v['03_hour'] + $v['041_hour'] + $v['042_hour'] + $v['043_hour'];
		$row_hour  = $v['01_hour'] + $v['02_hour'] + $v['03_hour'] + $v['041_hour'] + $v['042_hour'] ;
...
?>
	...
	<table align="center" width="'100%'">
		<tr>
			<td align="center">
<?php
		if ($this->session->userdata('acl')==='01'|| $this->session->userdata('acl')==='02' || $this->session->userdata('acl')==='03'){
			if ($form['project_approval']< 2 ) {
				echo '
				<div class="ff3 UILinkButton">
					<input type="submit"  id="submit_job"  value="Save" class="ff3 UILinkButton_A"/>
