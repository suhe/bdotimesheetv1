...
if ( count( $employee_data ) > 0 ) {
	...
	$employee .= '<option value="">Select Group</option>';
...
<tr>
	...
	<form id="form" method="POST" action="<?=base_url() ?>report/reportProjectGroup/" >
		<fieldset class="form-fieldset">
		<legend class="form-legend">Project Timesheet Per Group</legend>
		<table align=center>
		<tr>
