...
<tr>
	...
	<form id="form" method="POST" action="<?=$site ?>/report/reportTimesheetBudget/" >
		<fieldset class="form-fieldset">
		<legend class="form-legend">Budget &amp; Actual Project Per Manager </legend>
		<table align=center>
		<tr>
			<td class="label">End Periode : </td>
			<td>
...
<fieldset class="form-fieldset">
<legend class="form-legend">Budget &amp; Actual per  Manager </legend>
<table align=center>
<tr>
...
<thead>
<tr>
  <th class="table-head" colspan="12">Summary Report by  Employee</th>
</tr>
<tr>
	<th rowspan="2">No</th>
	<th rowspan="2">In Charge</th>
	<th rowspan="2">Position</th>
    <th rowspan="2" style="text-align: right;">Engangement</th>
	<th colspan="3" style="text-align: center;">Hours (per hour)</th>
	<th colspan="3" style="text-align: center;">Cost (IDR)</th>
    <th rowspan="2"></th>
</tr>
<tr>
