...
<table class="grid">
	<tr>
	<thead>
	<th class="table-head" colspan="13">Approved Timesheet</th>
		<tr>
			<th>No</th>
			<th>Date</th>
			<th>Week / Year</th>
...
if ( count( $table) > 0 ) {
	...
	foreach ($table as $k=>$v) {
		...
		if ($v['timesheet_approval'] == '3' ){
			$status = "Returned <a href='".$site."timesheet/returnDel/$v[timesheetid]/$v[timesheet_status_id]/$v[timesheetid]' class='hapus'>[ Del ]</a>";
		}
