...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>BDO Tanubrata - TimeSheet</title>
		...
		<script type="text/javascript" src="<?=$base_url ?>/js/jquery-ddi.js"></script>
		<script type="text/javascript" src="<?=$base_url ?>/js/jquery.datepick.min.js"></script>
